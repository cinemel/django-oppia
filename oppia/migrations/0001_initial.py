...
class Migration(migrations.Migration):
    ...
    STR_OPPIA_COHORT = 'oppia.Cohort'
    STR_OPPIA_COURSE = 'oppia.Course'
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge_icon', models.FileField(default=None,
                                                upload_to=b'badges',
                                                blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID',
                                        ...
                                        auto_created=True,
                                        primary_key=True)),
                ('cohort', models.ForeignKey(to=STR_OPPIA_COHORT,
                                             on_delete=models.CASCADE)),
                ('course', models.ForeignKey(to=STR_OPPIA_COURSE,
                                             on_delete=models.CASCADE)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filesize', models.BigIntegerField(default=None,
                                                    null=True,
                                                    blank=True)),
                ('media_length', models.IntegerField(default=None,
                                                     null=True,
                                                     blank=True)),
                ('course', models.ForeignKey(to=STR_OPPIA_COURSE,
                                             on_delete=models.CASCADE)),
            ...
            fields=[
                ...
                ('type',
                 models.CharField(max_length=20,
                                  choices=[(b'signup', b'Sign up'),
                                           (b'userquizattempt',
                                            b'Quiz attempt by user'),
                                           (b'firstattempt',
                                            b'First quiz attempt'),
                                           (b'firstattemptscore',
                                            b'First attempt score'),
                                           (b'firstattemptbonus',
                                            b'Bonus for first attempt score'),
                                           (b'quizattempt',
                                            b'Quiz attempt'),
                                           (b'quizcreated',
                                            b'Created quiz'),
                                           (b'activitycompleted',
                                            b'Activity completed'),
                                           (b'mediaplayed',
                                            b'Media played'),
                                           (b'badgeawarded',
                                            b'Badge awarded'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(default=None,
                                          ...
                                          upload_to=b'tags',
                                          blank=True)),
                ('courses', models.ManyToManyField(to=STR_OPPIA_COURSE,
                                                   through='oppia.CourseTag')),
                ('created_by', models.ForeignKey(to=settings.AUTH_USER_MODEL,
                                                 on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_title', models.TextField(default=None,
                                                    null=True,
                                                    blank=True)),
                ('section_title', models.TextField(default=None,
                                                   null=True,
                                                   blank=True)),
                ('uuid', models.TextField(default=None,
                                          null=True,
                                          blank=True)),
                ('lang', models.CharField(default=None,
                                          max_length=10,
                                          null=True,
                                          blank=True)),
                ('course', models.ForeignKey(default=None,
                                             blank=True,
                                             to=STR_OPPIA_COURSE,
                                             null=True,
                                             on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_title', models.TextField(default=None,
                                               null=True,
                                               blank=True)),
                ('organisation', models.TextField(default=None,
                                                  null=True,
                                                  blank=True)),
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(to=STR_OPPIA_COURSE,
                                    on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
